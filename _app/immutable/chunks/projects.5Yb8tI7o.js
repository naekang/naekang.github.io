import{A as e}from"./assets.D0yFt6OI.js";import{a as n}from"./skills.Czvdkd5X.js";const r=`## AWS DMS를 활용한 DB Migration
...
`,o=`## Tenant, Cell Provisioning 환경 구성
...
- NACL, Security Group 등을 활용한 보안 강화`,t=[{slug:"saas-operation",color:"#ff3e00",description:a,shortDescription:"NDC Aggregator Platform 운영 및 고도화",links:[],logo:e.Tidesquare,name:"NDC Aggregator Operation",period:{from:new Date(2023,2,2),to:new Date(2024,2,1)},skills:n("java","springboot","aws","sass"),type:"B2B SaaS",screenshots:[]},{slug:"saas-backend",color:"silver",description:r,shortDescription:"NDC Aggregator Platform SaaS 전환",links:[],logo:e.Tidesquare,name:"NDC Aggregator Platform SaaSification with AWS Proserve",period:{from:new Date(2024,2,1),to:new Date(2024,5,30)},skills:n("java","springboot","postgresql","aws"),type:"B2B SaaS",screenshots:[]},{slug:"saas-infra",color:"violet",description:o,shortDescription:"NDC Aggregator Platform Global Infra 구축 및 운영",links:[],logo:e.Tidesquare,name:"NDC Aggregator Platform Infra",period:{from:new Date(2024,5,30)},skills:n("terraform","kubernetes","aws","argocd"),type:"B2B SaaS",screenshots:[]}],s="Projects",g={title:s,items:t};export{g as P};
